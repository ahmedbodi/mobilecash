...
@property (nonatomic, readonly) UInt256 parentBlockHeaderHash;
...
@property (nonatomic, readonly) UInt256 parentBlockPrev;

// public Sha256Hash parentBlockMerkleRoot;
@property (nonatomic, readonly) UInt256 parentBlockMerkleRoot;
